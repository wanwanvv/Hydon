...
export default {
  ...
  methods:{
    myEcharts(){
      ...
      var ddata = require("../../../data/prediction/HAYDN/ambient_temp_prediction.json");
      var edata = require("../../../data/prediction/HAYDN/cpu_utilization_prediction.json");
      var fdata = require("../../../data/prediction/HAYDN/machine_temp_prediction.json");
      var gdata = require("../../../data/prediction/HAYDN/nyc_taxi_prediction.json");
      var hdata = require("../../../data/prediction/HAYDN/request_latency_prediction.json");
      var idata = require("../../../data/prediction/HAYDN/request_count_prediction.json");
