  ...
  export default {
    ...
    methods:{
      myEcharts(){
        ...
        var ddata = require("../../../data/prediction/ARIMA/ambient_temperature_prediction.json");
        var edata = require("../../../data/prediction/ARIMA/cpu_utilization_prediction.json");
        var fdata = require("../../../data/prediction/ARIMA/machine_temp_prediction.json");
        var gdata = require("../../../data/prediction/ARIMA/nyc_taxi_prediction.json");
        var hdata = require("../../../data/prediction/ARIMA/request_latency_prediction.json");
        var idata = require("../../../data/prediction/ARIMA/request_count_prediction.json");
