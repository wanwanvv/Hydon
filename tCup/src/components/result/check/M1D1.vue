  ...
  export default {
    ...
    methods:{
      myEcharts(){
        ...
        var ddata = require("../../../data/check/HAYDN/nyc_taxi.json");
        ...
        if( flag==0) {
          myChart_L1.setOption(showOption(numset1, numset2,'HAYDN模型-nyc_taxi数据集', pieces));
        }
      ...
      myEcharts2(){
        ...
        //var ddata = require("../../../data/check/ambient_temp.json");
        var ddata = require("../../../data/check/HAYDN/nyc_taxi.json");
        var adata = require("../../../data/check/ARIMA/nyc_taxi.json");
        var cdata = require("../../../data/check/CLASS/nyc_taxi.json");
        var rdata = require("../../../data/check/RNN/nyc_taxi.json");
