...
export default {
  ...
  methods:{
    myEcharts(){
      ...
      var ddata = require("../../../data/check/HAYDN/ambient_temp.json");
      ...
      if( flag==0) {
        myChart_L1.setOption(showOption(numset1, numset2,'HAYDN模型-ambient_temp数据集', pieces));
      }
    ...
    myEcharts2(){
      ...
      //var ddata = require("../../../data/check/ambient_temp.json");
      var ddata = require("../../../data/check/HAYDN/ambient_temp.json");
      var adata = require("../../../data/check/ARIMA/ambient_temp.json");
      var cdata = require("../../../data/check/CLASS/ambient_temp.json");
      var rdata = require("../../../data/check/RNN/ambient_temp.json");
